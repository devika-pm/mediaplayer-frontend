...
function Footer() {
  return (
    <div style={{widt:'100%',height:'300px'}} className='d-flex flex-column justify-content-center align-items-center'>
      <div className='footer-div d-flex justify-content-evenly w-100 flex-wrap'>
        <div className="website" style={{width:'400px'}}>
        <h4><i className="fa-solid fa-cloud-arrow-up fa-fade"></i> Media Player</h4>
        ...
        <div className="links d-flex flex-column">
          ...
          <Link to={'/home'} style={{textDecoration:'none',color:'white'}}>landing page</Link>
          <Link to={'/watch-history'} style={{textDecoration:'none',color:'white'}}>landing page</Link>
